    ...
    public class Basketball
    {
        public static void Run(string inputDir, string outputDir)
        {
            ...
            for (int index = 16; index < 21; index++)
            {
                ...
                editor.Deform(sequence, centers, indices, transformations, index - 10, out var deformedSequence, out var deformedCenters);
                MeshIO.WriteMeshToObj($"{outputDir}/Basketball/output/deformed_{index:000}.obj", deformedSequence.Meshes[index - 10]);
            ...
            */
            ...
            for (int index = 16; index < 21; index++)
            {
                ...
                MeshIO.WriteMeshToObj($"{outputDir}/Basketball/reference/deformed_reference_mesh_{index:000}.obj", deformedSequence.Meshes[0]);
            }
