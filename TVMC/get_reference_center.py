...
parser = argparse.ArgumentParser(description="Process 3D data and perform MDS.")
...
output_file = f"{centers_dir}/{dataset}_distance_matrix_{num_centers}.txt"
...
output_filename = f"{centers_dir}/reference_centers_aligned.xyz"
